...
qsub -o "/project/$root_project/$project/logs/blastn_$input_basename_$(date '+%Y%m%d')_stout.txt" \
    -e "/project/$root_project/$project/logs/blastn_$input_basename_$(date '+%Y%m%d')_stderr.txt" \
