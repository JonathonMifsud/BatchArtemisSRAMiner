...
qsub -o /project/"$root_project"/"$project"/logs/blastp_"$input_basename"_"$(date '+%Y%m%d')"_stout.txt \
    -e /project/"$root_project"/"$project"/logs/blastp_"$input_basename"_"$(date '+%Y%m%d')"_stderr.txt \
